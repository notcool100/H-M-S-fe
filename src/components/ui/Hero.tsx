		...
		<Container maxW={"7xl"}>
			...
			>
				<Stack flex={1} spacing={{ base: 5, md: 10 }}>
					...
					<Text color={"gray.500"}>
						Health Bridge connects you with the best healthcare services. Book
						appointments with specialists, order medicines online, schedule
						diagnostic tests, and access your medical records - all in one
						place.
					</Text>
					<Stack
						spacing={{ base: 4, sm: 6 }}
